...
def train(opt):
    ...
    #  Training
    # ----------
    opt.n_epochs = opt.num_steps//len(dataloader)
    print("Total number of epochs = ",opt.n_epochs)
    prev_time = time.time()
    # total_steps = 0
...
def test(opt):
    ...
    subset_sampler = SubsetRandomSampler(range(opt.num_steps))

    # DataLoader with the SubsetRandomSampler
